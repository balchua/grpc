...
public class NameGeneratorImpl implements NameGenerator {
    ...
    public Person generatePerson() {
        ...
        int left = random.nextInt(adjectives.length);
        int right = random.nextInt(scientists.length);

        Person person = Person.newBuilder()
                .setFirstName(scientists[right])
                .setLastName(scientists[right])
                .setId(right)
                .setDescription(adjectives[left]).build();
